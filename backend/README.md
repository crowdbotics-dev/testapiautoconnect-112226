...
## Project Structure
    ...
    ├── testapiautoconnect_112226  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112226`
...
2. Clone this repo and `cd testapiautoconnect_112226`
